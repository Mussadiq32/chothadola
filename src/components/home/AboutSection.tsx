    ...
    <section id="about" className="section-padding relative overflow-hidden">
      ...
      <div className="container mx-auto relative">
        ...
        >
          ...
          <p className="text-royal-600 text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {stats.map((stat, index) => (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 text-center transform transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group"
            >
              <div className={cn(
              ...
              <div className="text-3xl font-bold text-royal-800 mb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center mb-20">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-gold-200">
              <img 
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-royal-900/40 to-royal-900/10 rounded-2xl"></div>
              ...
              <div className="absolute bottom-4 left-4 z-20">
                <div className="w-8 h-8 bg-gradient-to-r from-royal-400 to-royal-600 rounded-full flex items-center justify-center shadow-lg">
            ...
            <motion.div 
              className="absolute -bottom-10 -right-10 lg:bottom-10 lg:right-[-80px] bg-white p-6 rounded-2xl shadow-2xl max-w-xs transform transition-all duration-500 hover:shadow-3xl hover:-translate-y-2"
            ...
            >
              <div className="relative">
                <div className="absolute top-0 left-0 w-12 h-12 bg-gradient-to-r from-gold-400 to-gold-600 rounded-full flex items-center justify-center transform -translate-x-6 -translate-y-6 shadow-lg">
          ...
          >
            <Tabs defaultValue="vision" className="w-full" onValueChange={setActiveTab}>
              <TabsList className="grid grid-cols-3 mb-8 bg-white/80 backdrop-blur-sm border border-gray-200">
                ...
                <TabsTrigger value="team" className="text-sm font-medium">
              ...
              <TabsContent value="vision" className="animate-fade-up">
                <div className="bg-gradient-to-br from-royal-50 to-gold-50 rounded-2xl p-8 border border-gold-100">
                  <h3 className="text-xl font-bold text-royal-800 mb-6 flex items-center">
                    <Target className="w-6 h-6 mr-3 text-gold-500" />
                    Our Vision & Mission
                  </h3>
                  <p className="text-royal-600 mb-6 leading-relaxed">
                  ...
                  <p className="text-royal-600 mb-8 leading-relaxed">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    {values.map((value, index) => (
                      <div key={index} className="flex items-center space-x-3 p-3 bg-white/50 rounded-xl border border-gold-100">
                        <div className={cn(
                        ...
                        <div>
                          <h4 className="font-semibold text-royal-800 text-sm">{value.title}</h4>
                ...
                <div className="bg-gradient-to-br from-royal-50 to-gold-50 rounded-2xl p-8 border border-gold-100">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    {achievements.map((achievement, index) => (
                      <motion.div 
                        key={index} 
                        className="flex items-start p-4 rounded-xl bg-white/50 border border-gold-100 hover:bg-white/80 transition-all duration-300"
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
                    {[
                      ...
                      <div key={index} className="text-center">
                        <div className="w-20 h-20 mx-auto rounded-full overflow-hidden mb-3 border-2 border-gold-200 shadow-lg">
                          <img 
                            src={member.image} 
                            alt={member.name} 
                            className="w-full h-full object-cover"
        ...
        <div className="mb-16">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-gold-400 to-gold-600 text-white text-sm font-medium rounded-full mb-4 shadow-lg">
              <Clock size={16} className="mr-2" />
              Our Journey
            </div>
            <h3 className="text-3xl font-bold text-royal-800 mb-4">Milestones That Define Us</h3>
            <p className="text-royal-600 max-w-3xl mx-auto text-lg">
          ...
          <div className="relative">
            ...
            <div className="relative">
              {milestones.map((milestone, index) => (
                ...
                >
                  <div 
                    className={`w-5/12 flex ${index % 2 === 0 ? 'justify-end pr-10' : 'justify-start pl-10'}`}
                  >
                    <motion.div 
                      className="bg-white/95 backdrop-blur-sm p-6 rounded-2xl shadow-xl border border-gray-100 max-w-sm transform transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 group"
                      whileHover={{ scale: 1.05 }}
                    >
                      {/* Icon and Year Header */}
                      <div className="flex items-center justify-between mb-3">
                        <div className={`p-2.5 bg-gradient-to-r ${milestone.color} rounded-lg shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                          {milestone.icon}
                        </div>
                        <div className="text-right">
                          <div className="text-xl font-bold text-gold-500 mb-1">{milestone.year}</div>
                          <div className="text-xs text-royal-500 font-medium">Milestone</div>
                        </div>
                      </div>
                      
                      {/* Content */}
                      <h4 className="text-lg font-bold text-royal-800 mb-2 group-hover:text-gold-600 transition-colors duration-300">
                        {milestone.title}
                      </h4>
                      <p className="text-royal-600 mb-3 leading-relaxed text-sm">
                  ...
                  <motion.div 
                    className="absolute left-1/2 transform -translate-x-1/2 w-5 h-5 rounded-full bg-gradient-to-r from-gold-400 to-gold-600 border-3 border-white shadow-lg z-10"
                    initial={{ scale: 0 }}
                    whileInView={{ scale: 1 }}
        ...
        <motion.div 
          className="bg-gradient-to-r from-royal-800 to-royal-900 rounded-2xl p-10 text-center relative overflow-hidden"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
